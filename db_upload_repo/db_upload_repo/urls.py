...
from db_upload_repo import views
...
urlpatterns = [
    ...
    url(r"^db_uploads/$", views.root_upload_view, name="all_projects"),
    url(r"^db_uploads/(?P<project>[^/]+)/$",
        views.project_root_view,
        name="root_project"),
    url(r"^db_uploads/(?P<project>[^/]+)/latest/$",
        views.project_latest_view,
        name="project_latest"),
    url(r"^db_uploads/(?P<project>[^/]+)/historical/$",
        views.project_historical_view,
        name="project_historical"),
    url(r"^db_uploads/(?P<project>[^/]+)/latest/(?P<file_name>[^/]+)$",
        views.latest_download_view,
        name="file_latest"),
    url(r"^db_uploads/(?P<project>[^/]+)/historical/(?P<file_name>[^/]+)$",
